...
[![](https://img.shields.io/github/v/release/MahanElectronic/3x-ui.svg)](https://github.com/MahanElectronic/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/MahanElectronic/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/MahanElectronic/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/MahanElectronic/3x-ui/total.svg)](#)
...
<p align="left"><a href="#"><img width="125" src="https://github.com/MahanElectronic/3x-ui/assets/115543613/7aa895dd-048a-42e7-989b-afd41a74e2e1" alt="Image"></a></p>
...
```
bash <(curl -Ls https://raw.githubusercontent.com/MahanElectronic/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/MahanElectronic/3x-ui/master/install.sh) v2.3.6
```
...
wget https://github.com/MahanElectronic/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. Clone the Project Repository:
   ...
   ```sh
   git clone https://github.com/MahanElectronic/3x-ui.git
   cd 3x-ui
   ```
...
3. Start the Service
   ...
   docker run -itd \
      ...
      --name 3x-ui \
      ghcr.io/MahanElectronic/3x-ui:latest
   ```
...
[![Stargazers over time](https://starchart.cc/MahanElectronic/3x-ui.svg)](https://starchart.cc/MahanElectronic/3x-ui)
